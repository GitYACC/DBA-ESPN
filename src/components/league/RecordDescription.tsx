                    ...
                    <div className="flex justify-between">
                        <div>
                            <div className="flex items-center gap-2">
                                <div className="p-1 w-8 flex justify-center items-center text-blue-600 bg-blue-50 rounded-md border border-blue-200">{props.active.position}</div>
                                <div className="font-semibold text-gray-900">{props.active.name.split(" ")[0]}</div>
                            </div>
                            <p className="text-2xl tracking-[-0.048rem] font-semibold text-gray-900">{props.active.name.split(" ")[1]}</p>
                        </div>
                ...
                <div className="flex flex-col overflow-hidden border-[1px] rounded-lg divide-y">
                    ...
                    <div className="flex gap-7 px-6 py-2">
                        <div className="flex flex-col w-14 justify-center items-center">
                            ...
                            <div className="font-bold text-2xl text-gray-900">{props.active.points}</div>
                            <div className="text-xs text-gray-400">1st</div>
                        </div>
                        <div className="flex flex-col w-14 justify-center items-center">
                            <div className="text-xs text-gray-400">REB</div>
                            <div className="font-bold text-2xl text-gray-900">{props.active.rebounds}</div>
                            <div className="text-xs text-gray-400">2nd</div>
                        </div>
                        <div className="flex flex-col w-14 justify-center items-center">
                            <div className="text-xs text-gray-400">AST</div>
                            <div className="font-bold text-2xl text-gray-900">{props.active.assists}</div>
                            <div className="text-xs text-gray-400">2nd</div>
                        </div>
                        <div className="flex flex-col w-14 justify-center items-center">
                            <div className="text-xs text-gray-400">FG%</div>
                            <div className="font-bold text-2xl text-gray-900">{props.active.fgpercent}%</div>
                            <div className="text-xs text-gray-400">1st</div>
                        </div>
                    </div>
                </div>
